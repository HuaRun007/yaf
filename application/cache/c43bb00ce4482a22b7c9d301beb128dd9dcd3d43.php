    ...
    <form data-toggle="ajaxsearch" data-options="{searchDatagrid:$.CurrentNavtab.find('#arealist-table')}">
        <fieldset>
            ...
            <div class="bjui-row col-4">
                ...
                <div class="row-input ">
                    <input type="text" name="areaid" value="<?php echo e($areaid); ?>"  placeholder="请输入片区编码" ></div>


                <label class="row-label">片区名称</label>
                <div class="row-input">
                    <input type="text" name="areaname" value="<?php echo e($areaname); ?>" placeholder="请输入片区名称" ></div>
...
<div class="bjui-pageContent clearfix">
    ...
    <table class="table table-bordered" id="arealist-table" data-toggle="datagrid" data-options="{
        ...
        dataUrl: 'Admin_Write/articlelistJson',
        dataType: 'json',
        jsonPrefix: 'obj',
