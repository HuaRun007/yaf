            ...
            <div class="bjui-row col-3">
                ...
                <div class="row-input required">
                    <select name="article_type" id="article_type" data-toggle="selectpicker" data-rule="required" data-width="100%"
                        ...
                        <?php $__currentLoopData = $articletype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item['id']); ?>"><?php echo e($item['typename']); ?></option>
                ...
                <div class="row-input">
                    <select name="" data-toggle="selectpicker" data-rule="required" data-width="100%"
                        ...
                        <option value="1" <?php if($articlestatus==1): ?> checked <?php endif; ?>>新建</option>
                        <option value="2" <?php if($articlestatus==2): ?> checked <?php endif; ?>>暂存</option>
                        <option value="3" <?php if($articlestatus==3): ?> checked <?php endif; ?>>发布</option>
                    </select>
                </div>
