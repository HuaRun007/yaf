...
<!-- bootstrap - css -->
<link href="/static/B-JUI/themes/css/bootstrap.css" rel="stylesheet">
<!-- core - css -->
<link href="/static/B-JUI/themes/css/style.css" rel="stylesheet">
<link href="/static/B-JUI/themes/blue/core.css" id="bjui-link-theme" rel="stylesheet">
<link href="/static/B-JUI/themes/css/fontsize.css" id="bjui-link-theme" rel="stylesheet">
<!-- plug - css -->
<link href="/static/B-JUI/plugins/kindeditor_4.1.11/themes/default/default.css" rel="stylesheet">
<link href="/static/B-JUI/plugins/colorpicker/css/bootstrap-colorpicker.min.css" rel="stylesheet">
<link href="/static/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.css" rel="stylesheet">
<link href="/static/B-JUI/plugins/bootstrapSelect/bootstrap-select.css" rel="stylesheet">
<link href="/static/B-JUI/plugins/webuploader/webuploader.css" rel="stylesheet">
<link href="/static/B-JUI/themes/css/FA/css/font-awesome.min.css" rel="stylesheet">
<!-- Favicons -->
<link rel="apple-touch-icon-precomposed" href="assets/ico/apple-touch-icon-precomposed.png">
<link rel="shortcut icon" href="assets/ico/favicon.png">
<!--[if lte IE 7]>
<link href="/static/B-JUI/themes/css/ie7.css" rel="stylesheet">
<![endif]-->
<!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
<!--[if lte IE 9]>
    <script src="/static/B-JUI/other/html5shiv.min.js"></script>
    <script src="/static/B-JUI/other/respond.min.js"></script>
<![endif]-->
<!-- jquery -->
<script src="/static/B-JUI/js/jquery-1.11.3.min.js"></script>
<script src="/static/B-JUI/js/jquery.cookie.js"></script>
<!--[if lte IE 9]>
<script src="/static/B-JUI/other/jquery.iframe-transport.js"></script>
<![endif]-->
<!-- B-JUI -->
<script src="/static/B-JUI/js/bjui-all.min.js"></script>
<!-- plugins -->
<!-- swfupload for kindeditor -->
<script src="/static/B-JUI/plugins/swfupload/swfupload.js"></script>
<!-- Webuploader -->
<script src="/static/B-JUI/plugins/webuploader/webuploader.js"></script>
<!-- kindeditor -->
<script src="/static/B-JUI/plugins/kindeditor_4.1.11/kindeditor-all-min.js"></script>
<script src="/static/B-JUI/plugins/kindeditor_4.1.11/lang/zh-CN.js"></script>
<!-- colorpicker -->
<script src="/static/B-JUI/plugins/colorpicker/js/bootstrap-colorpicker.min.js"></script>
<!-- ztree -->
<script src="/static/B-JUI/plugins/ztree/jquery.ztree.all-3.5.js"></script>
<!-- nice validate -->
<script src="/static/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.js"></script>
<script src="/static/B-JUI/plugins/nice-validator-1.0.7/jquery.validator.themes.js"></script>
<!-- bootstrap plugins -->
<script src="/static/B-JUI/plugins/bootstrap.min.js"></script>
<script src="/static/B-JUI/plugins/bootstrapSelect/bootstrap-select.min.js"></script>
<script src="/static/B-JUI/plugins/bootstrapSelect/defaults-zh_CN.min.js"></script>
<!-- icheck -->
<script src="/static/B-JUI/plugins/icheck/icheck.min.js"></script>
<!-- HighCharts -->
<script src="/static/B-JUI/plugins/highcharts/highcharts.js"></script>
<script src="/static/B-JUI/plugins/highcharts/highcharts-3d.js"></script>
<script src="/static/B-JUI/plugins/highcharts/themes/gray.js"></script>
<!-- other plugins -->
<script src="/static/B-JUI/plugins/other/jquery.autosize.js"></script>
<link href="/static/B-JUI/plugins/uploadify/css/uploadify.css" rel="stylesheet">
<script src="/static/B-JUI/plugins/uploadify/scripts/jquery.uploadify.min.js"></script>
<script src="/static/B-JUI/plugins/download/jquery.fileDownload.js"></script>
<!-- init -->
...
<body>
        ...
        <div class="container_fluid">
            ...
            <nav class="collapse navbar-collapse" id="bjui-top-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="Index/reset" style="font-weight:bold;">&nbsp;<i class="fa fa-power-off"></i> 注销登陆</a></li>
        ...
        <div class="container_fluid">
            ...
            <nav class="collapse navbar-collapse" id="bjui-navbar-collapse">
                <ul class="nav navbar-nav navbar-right" id="bjui-hnav-navbar">
                    <li class="active">
                        <a href="json/menu-form.json" data-toggle="sidenav" data-id-key="targetid">文章管理</a>
                    </li>
                    <li>
                        <a href="json/menu-base.json" data-toggle="sidenav" data-id-key="targetid">系统管理</a>
                    </li>
                    <li>
                        <a href="json/menu-datagrid.json" data-toggle="sidenav" data-id-key="targetid">数据表格</a>
                    </li>
                </ul>
            </nav>
        </div>
                ...
                <div class="navtab-panel tabsPageContent">
                    <div class="navtabPage unitBox">
                        <div class="bjui-pageContent">
                            <image src="/static/images/1.jpg" style="width: 100%;height: 100%" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="/static/B-JUI/other/ie10-viewport-bug-workaround.js"></script>
</body>
</html>